...
export const darkTheme = {
  colors: {
    ...
    primary: '#63b3ed',
    secondary: '#a0aec0',
    userMessageBackground: '#4d4800ff',
    ...
    thoughtContainerBackground: '#333333',
    thoughtButtonBackground: '#444444',
    thoughtButtonText: '#e2e8f0',
    thoughtContentBackground: '#3a3a3a',
    thoughtContainerBorder: '#666666',
  },
  spacing: {
    small: 8,
    medium: 16,
